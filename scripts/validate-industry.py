...
def _cpl_category(industry, model_key):
    ...
    mappings = [
        ...
        ("dental implant", "dental_implants"), ("cosmetic dentist", "cosmetic_dentistry"), ("chiropract", "chiropractor"), ("painting", "painting"), ("dental medtech", "healthcare_equip"), ("dental", "dental"), ("hvac", "hvac"), ("roof", "roofing"),
