...
CPL_RANGES = {
    ...
    "dental":           (15, 120),
    "orthodontics":     (40, 200),
    "dental_surgery":   (75, 300),
    "dental_implants":  (100, 450),
    "cosmetic_dentistry": (45, 150),
    "hvac":             (20, 150),
    "commercial_hvac_services": (80, 350),
    "beauty_wholesale":     (45, 180),
    "wholesale":            (40, 200),
    "facilities_services": (60, 250),
    "spiritual_retreat": (30, 150),
    "roofing":          (25, 200),
    "plumbing":         (15, 120),
    "landscaping":      (15, 100),
    "cleaning":         (10, 80),
    ...
    "residential_home_building": (150, 500),
    "general_contracting": (25, 200),
    "flooring":          (20, 150),
    "drywall":           (15, 100),
    "auto_repair":       (15, 100),
    "car_wash":          (5, 50),
    "health_retreat":    (40, 150),
    "childrens_clothing": (0.30, 2.50),
    "solar":             (30, 250),
    "pool":              (30, 500),
    "water_system_service": (30, 120),
    "pool_maintenance":  (25, 120),
    "pool_renovation":   (500, 10000),
    "window":            (20, 150),
    "window_repair":     (20, 140),
    "beauty_spa":        (10, 80),
    "hair_salon":        (10, 70),
    "dog_grooming":      (10, 60),
    "therapy":           (35, 150),
    ...
    "premium_powersports_dealer": (80, 250),
    "rv_dealer":         (15, 150),
    "plastic_surgery":   (100, 400),
    "pest_control":      (20, 80),
    ...
    "security_investigations": (80, 300),
    "security_protective": (40, 200),
    "tropical_destination": (15, 100),
    "franchise_restaurant": (15, 65),
    "consulting_services_b2b": (100, 400),
    "b2b_office_service": (75, 275),
    "healthcare_b2b_app": (150, 400),
    "b2b_healthcare_services": (120, 350),
    "logistics":         (100, 450),
    ...
    "medical_document_platform": (0.15, 10.00),
...
def _cpl_category(industry, model_key):
    ...
    mappings = [
        ...
        ("children", "childrens_clothing"), ("kids clothing", "childrens_clothing"),
        ...
        ("beauty wholesale", "beauty_wholesale"),
        ("hair salon", "hair_salon"),
        ("window repair", "window_repair"), ("window", "window"), ("beauty spa", "beauty_spa"), ("wax", "beauty_spa"),
        ("men's health", "mens_health_clinic"), ("mens health", "mens_health_clinic"), ("testosterone", "mens_health_clinic"),
        ...
        ("marine", "luxury_marine_dealer"), ("yacht", "luxury_marine_dealer"),
        ("luxury marine", "luxury_marine_dealer"),
        ...
        ("video production", "video_production"), ("videography", "video_production"),
        ("wedding", "wedding_photo"), ("photo", "wedding_photo"),
        ("rv ", "rv_dealer"), ("mobile home", "rv_dealer"),
        ("powersports", "premium_powersports_dealer"), ("motorsports", "premium_powersports_dealer"),
        ("dealership", "automotive_dealer"),
        ("logistics", "logistics"), ("supply chain", "logistics"), ("freight", "logistics"),
        ("franchise development", "franchise_development"), ("franchisor", "franchise_development"), ("multi-brand franchisor", "franchise_development"),
        ("municipal infrastructure", "municipal_infrastructure"), ("municipal", "municipal_infrastructure"),
        ("digital marketing agency", "digital_marketing_agency"), ("marketing agency", "digital_marketing_agency"),
        ("creative branding agency", "creative_branding_agency"), ("creative agency", "creative_branding_agency"), ("branding agency", "creative_branding_agency"),
        ...
        ("security and protective", "security_protective"),
        ...
        ("college", "education"), ("higher education", "education"),
        ("educat", "education"),
        ...
        ("b2b healthcare service", "b2b_healthcare_services"),
        ...
        ("financial advising", "financial_advising"),
        ...
        ("entertainment event", "entertainment_events"), ("event planning", "entertainment_events"), ("entertainment venue", "entertainment_events"),
        ...
        ("medical document platform", "medical_document_platform"),
        ("medical document management", "medical_document_platform"),
        ...
        ("health retreat", "health_retreat"), ("wellness retreat", "health_retreat"),
        ("specialty medical", "specialty_medical"),
...
DEAL_VALUE_RANGES = {
    ...
    "painting": (2000, 10000),
    "dental": (300, 5000),
    "orthodontics": (5000, 6500),
    "dental_surgery": (1500, 5000),
    "dental_implants": (5000, 15000),
    "cosmetic_dentistry": (1500, 5000),
    "hvac": (2000, 15000),
    "commercial_hvac_services": (5000, 35000),
    "beauty_wholesale": (2500, 15000),
    "wholesale": (5000, 50000),
    "facilities_services": (5000, 25000),
    "spiritual_retreat": (1200, 4000),
    "roofing": (5000, 30000),
    "plumbing": (300, 6000),
    ...
    "residential_home_building": (300000, 1000000),
    "general_contracting": (8000, 120000),
    "flooring": (2000, 20000),
    "drywall": (500, 10000),
    "mens_health_clinic": (2400, 6000),
    "specialty_medical": (2000, 7000),
    "auto_repair": (300, 4000),
    "car_wash": (20, 300),
    "health_retreat": (1500, 5000),
    "childrens_clothing": (35, 65),
    "solar": (10000, 45000),
    "pool": (15000, 100000),
    "water_system_service": (800, 4500),
    "pool_maintenance": (300, 2500),
    ...
    "luxury_marine_dealer": (80000, 400000),
    "print_shop": (200, 8000),
    "art_studio": (100, 500),
