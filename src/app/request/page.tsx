      ...
      <div className="min-h-screen bg-[#FDFDFD] flex items-center justify-center p-6">
        <div className="max-w-md text-center">
          ...
          <p className="text-gray-600">
            Your case study request has been received. June will build it and send you the case study link by email once it&apos;s ready. This usually takes about 5-10 minutes.
          </p>
        </div>
      </div>
    );
