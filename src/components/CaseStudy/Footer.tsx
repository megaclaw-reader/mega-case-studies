  ...
  return (
    <footer className="py-16 px-6 border-t border-gray-100 mt-10">
      <div className="max-w-6xl mx-auto text-center">
        <div className="mb-6">
          <a
            href="https://www.gomega.ai/demo"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block text-base font-semibold text-white bg-[#2454FF] hover:bg-[#1a3fd4] px-8 py-3 rounded-lg transition-colors"
          >
            Book a Demo
          </a>
        </div>
        <div className="mb-4 flex justify-center">
          <a href="https://www.gomega.ai/" target="_blank" rel="noopener noreferrer">
