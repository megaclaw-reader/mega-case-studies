...
function ForbesLogo() {
  // Actual Forbes wordmark from Wikimedia Commons
  return (
...
/* Using ACTUAL logo assets downloaded from each company's website */
...
function AtreidesLogo() {
  // Using actual logo image from atreidesmgmt.com
  return (
    <img
      src="/logos/atreides-banner.png"
      alt="Atreides Management"
...
function SignalFireLogo() {
  // Using actual SignalFire wordmark PNG from signalfire.com
  // CSS brightness-0 invert makes it white on dark bg
  return (
    <img
      src="/logos/signalfire-wordmark.png"
      alt="SignalFire"
