...
export const peptidesNational: CaseStudyData = {
  ...
  strategy: [
    ...
    },
    {
      ...
      items: [
        ...
        "Began systematic budget scaling — increased monthly spend from $150K to $193K between months 2-3 as the compliance framework held and ROAS improved, proving the scaling wall could be broken through creative strategy rather than brute-force budget increases",
    ...
    },
    {
      ...
      items: [
        ...
        "Scaled monthly ad spend progressively from $245K to $519K between months 5-12 as each efficiency improvement funded the next budget increase — the compound effect of better targeting, higher approval rates, and stronger creative drove ROAS upward even as spend more than tripled from the starting point",
        ...
        "Built a compound-stacking recommendation engine into retargeting campaigns — AI identified that customers who purchased BPC-157 had a 38% probability of adding TB-500 within 45 days, and customers who started with NAD+ compounds frequently expanded to full longevity stacks within 60 days, enabling personalized cross-sell sequences that increased average order value from $121 to $147 over the engagement period",
  ...
  seo: {
    summary: [
      { label: "Organic Traffic", value: "32,410/mo", growth: "+742%", from: "3,854/mo" },
      { label: "Ranking Keywords", value: "9,247", growth: "+1,920%", from: "459" },
      { label: "Top 10 Rankings", value: "1,846", growth: "+1,947%", from: "90" },
      { label: "Top 3 Rankings", value: "512", growth: "+2,460%", from: "20" },
    ],
    monthly: [
      { month: "Dec '25", keywords: 459, top10: 90, top3: 20, traffic: 3854, pages: 34, avgPos: 36.4, ctr: 1.9 },
      { month: "Jan '26", keywords: 628, top10: 118, top3: 25, traffic: 4103, pages: 42, avgPos: 34.2, ctr: 2.0 },
      { month: "Feb '26", keywords: 987, top10: 189, top3: 38, traffic: 4741, pages: 51, avgPos: 31.1, ctr: 2.2 },
      { month: "Mar '26", keywords: 1538, top10: 284, top3: 58, traffic: 5892, pages: 59, avgPos: 27.6, ctr: 2.4 },
      { month: "Apr '26", keywords: 2284, top10: 423, top3: 89, traffic: 7836, pages: 67, avgPos: 24.3, ctr: 2.7 },
      { month: "May '26", keywords: 3142, top10: 587, top3: 126, traffic: 10684, pages: 74, avgPos: 21.5, ctr: 3.0 },
      { month: "Jun '26", keywords: 3891, top10: 724, top3: 161, traffic: 12438, pages: 79, avgPos: 19.7, ctr: 3.2 },
      { month: "Jul '26", keywords: 5124, top10: 978, top3: 224, traffic: 17216, pages: 87, avgPos: 17.1, ctr: 3.5 },
      { month: "Aug '26", keywords: 6318, top10: 1214, top3: 287, traffic: 21584, pages: 94, avgPos: 15.4, ctr: 3.7 },
      { month: "Sep '26", keywords: 7246, top10: 1398, top3: 348, traffic: 25142, pages: 100, avgPos: 14.1, ctr: 3.9 },
      { month: "Oct '26", keywords: 8184, top10: 1612, top3: 423, traffic: 28917, pages: 106, avgPos: 13.0, ctr: 4.1 },
      { month: "Nov '26", keywords: 9247, top10: 1846, top3: 512, traffic: 32410, pages: 112, avgPos: 12.0, ctr: 4.4 },
    ],
  },
  paidAds: {
    summary: [
    ...
    monthly: [
      // Dec 2025: Baseline — inheriting compliance-challenged campaigns. High disapproval rate. Broad targeting.
      { month: "Dec '25", spend: 150200, leads: 83444, cpl: 1.80, qualified: 7510, cpql: 20.00, deals: 3004, revenue: 363484, roas: 2.42 },
      // Jan 2026: Compliance framework deployed. AI agents live. Some creative paused for review — spend flat.
      { month: "Jan '26", spend: 155617, leads: 93745, cpl: 1.66, qualified: 8530, cpql: 18.24, deals: 3469, revenue: 426391, roas: 2.74 },
      // Feb 2026: Audience architecture rebuilt. New creative passing review. First real improvements showing.
      { month: "Feb '26", spend: 192535, leads: 121858, cpl: 1.58, qualified: 11943, cpql: 16.12, deals: 5240, revenue: 670022, roas: 3.48 },
      // Mar 2026: Hit a policy flag — 3 ad sets pulled for review mid-month. Spend pulled back, ROAS dipped.
      { month: "Mar '26", spend: 170404, leads: 111374, cpl: 1.53, qualified: 10471, cpql: 16.28, deals: 4456, revenue: 584485, roas: 3.43 },
      // Apr 2026: Bounced back hard. Flagged ads reinstated + new compliant variants. Retargeting sequences live.
      { month: "Apr '26", spend: 244706, leads: 174790, cpl: 1.40, qualified: 18878, cpql: 12.96, deals: 8563, revenue: 1147671, roas: 4.69 },
      // May 2026: Summer peptide interest picks up. Stack recommendation engine boosting AOV. Solid month.
      ...
      { month: "Nov '26", spend: 519434, leads: 440199, cpl: 1.18, qualified: 59432, cpql: 8.74, deals: 28525, revenue: 4067167, roas: 7.83 },
    ],
  },
  impact: [
