...
export const wearableHealthTechTx: CaseStudyData = {
  ...
  organicConversions: {
    ...
    sources: [
      { source: "Organic Search (Non-Branded)", percentage: 54, leads: 23179 },
      { source: "Organic Search (Branded)", percentage: 31, leads: 20016 },
      { source: "Content & Comparison Pages", percentage: 15, leads: 18168 },
    ],
  },
  impact: [
