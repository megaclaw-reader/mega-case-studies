...
export const roofingNewMexico: CaseStudyData = {
  ...
  industry: "Roofing",
  headline: "How a New Mexico Roofing Company Generated $542.2K in Revenue From Paid Advertising in 10 Months",
  subheadline: "MEGA helped a residential roofing contractor in New Mexico reduce their cost per qualified lead by 38% and close 44 deals worth $542.2K through AI-powered paid advertising — leveraging monsoon season demand and always-on campaign optimization.",
  heroStats: [
    { value: "10", unit: "months", label: "Partnership Duration" },
    { value: "$542.2K", unit: "K", label: "Revenue Attributed" },
  ...
  strategy: [
    {
      ...
      items: [
        "Complete Paid advertising account audit and restructure — separated campaigns by service type (storm damage repair, full replacement, new construction, maintenance/inspection) with dedicated landing pages for each",
  ...
  paidAds: {
    summary: [
      ...
      { label: "Avg Cost Per Qualified Lead", value: "$656" },
    ...
    monthly: [
      { month: "Jun '25", spend: 12400, leads: 82, cpl: 151, qualified: 19, cpql: 653, deals: 5, revenue: 51336, roas: 4.14 },
      { month: "Jul '25", spend: 16800, leads: 86, cpl: 195, qualified: 15, cpql: 1120, deals: 4, revenue: 54264, roas: 3.23 },
      { month: "Aug '25", spend: 17200, leads: 103, cpl: 167, qualified: 19, cpql: 905, deals: 4, revenue: 54696, roas: 3.18 },
      { month: "Sep '25", spend: 15900, leads: 91, cpl: 175, qualified: 18, cpql: 883, deals: 4, revenue: 55968, roas: 3.52 },
      { month: "Oct '25", spend: 13600, leads: 112, cpl: 121, qualified: 24, cpql: 567, deals: 6, revenue: 56440, roas: 4.15 },
      { month: "Nov '25", spend: 12700, leads: 116, cpl: 109, qualified: 23, cpql: 552, deals: 6, revenue: 50419, roas: 3.97 },
      { month: "Dec '25", spend: 12100, leads: 112, cpl: 108, qualified: 22, cpql: 550, deals: 5, revenue: 47795, roas: 3.95 },
      { month: "Jan '26", spend: 12300, leads: 119, cpl: 103, qualified: 22, cpql: 559, deals: 5, revenue: 54858, roas: 4.46 },
      { month: "Feb '26", spend: 12800, leads: 114, cpl: 112, qualified: 26, cpql: 492, deals: 6, revenue: 55424, roas: 4.33 },
      { month: "Mar '26", spend: 13900, leads: 131, cpl: 106, qualified: 25, cpql: 556, deals: 7, revenue: 61021, roas: 4.39 },
    ],
  },
  impact: [
    { label: "Total Revenue", value: "$542.2K", growth: "+284%" },
    { label: "Total Qualified Leads", value: "213", growth: "↓38% Cost Per Lead" },
    { label: "Closed Deals", value: "52", growth: "+167%" },
