...
export const weddingPhotographyAtlanta: CaseStudyData = {
  ...
  headline: "How an Atlanta Wedding Photography Studio Booked $30.7K in Revenue With AI-Powered Marketing",
  ...
  heroStats: [
    ...
    { value: "$30.7K", unit: "K", label: "Revenue Booked" },
  ...
  paidAds: {
    ...
    monthly: [
      { month: "Jan 2025", spend: 6585, leads: 34, cpl: 194, qualified: 7, cpql: 941, deals: 2, revenue: 3671, roas: 0.56 },
      { month: "Feb 2025", spend: 7240, leads: 41, cpl: 177, qualified: 9, cpql: 804, deals: 3, revenue: 4891, roas: 0.68 },
      { month: "Mar 2025", spend: 8415, leads: 53, cpl: 159, qualified: 12, cpql: 701, deals: 4, revenue: 7365, roas: 0.88 },
      { month: "Apr 2025", spend: 9870, leads: 68, cpl: 145, qualified: 16, cpql: 617, deals: 4, revenue: 5680, roas: 0.58 },
      { month: "May 2025", spend: 11350, leads: 82, cpl: 138, qualified: 19, cpql: 597, deals: 6, revenue: 9085, roas: 0.8 },
    ],
  },
  impact: [
    { label: "Total Revenue", value: "$30.7K", growth: "+284%" },
    { label: "Total Pipeline", value: "$367K", growth: "+219%" },
    { label: "Avg Package Value", value: "$3,533", growth: "" },
    { label: "Blended ROAS", value: "0.71x", growth: "" },
  ],
};
