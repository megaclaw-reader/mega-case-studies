...
export const weddingPhotographyAtlanta: CaseStudyData = {
  ...
  headline: "How an Atlanta Wedding Photography Studio Booked $199.4K in Revenue With AI-Powered Marketing",
  subheadline: "MEGA helped a boutique wedding photography studio in Atlanta build organic search authority and optimize paid advertising, growing domain authority from 8 to 24, increasing organic traffic by 1,619%, and generating 61 booked weddings worth $199.4K in just 5 months.",
  heroStats: [
    { value: "5", unit: "months", label: "Partnership Duration" },
    { value: "$199.4K", unit: "K", label: "Revenue Booked" },
  ...
  paidAds: {
    summary: [
      ...
      { label: "Qualified Leads", value: "63" },
      { label: "Avg Cost Per Qualified Lead", value: "$690", note: "↓36% from $470" },
    ...
    monthly: [
      { month: "Jan 2025", spend: 6585, leads: 34, cpl: 194, qualified: 7, cpql: 941, deals: 2, revenue: 15211, roas: 2.31 },
      { month: "Feb 2025", spend: 7240, leads: 41, cpl: 177, qualified: 9, cpql: 804, deals: 3, revenue: 24471, roas: 3.38 },
      { month: "Mar 2025", spend: 8415, leads: 53, cpl: 159, qualified: 12, cpql: 701, deals: 4, revenue: 33576, roas: 3.99 },
      { month: "Apr 2025", spend: 9870, leads: 68, cpl: 145, qualified: 16, cpql: 617, deals: 4, revenue: 52114, roas: 5.28 },
      { month: "May 2025", spend: 11350, leads: 82, cpl: 138, qualified: 19, cpql: 597, deals: 6, revenue: 74002, roas: 6.52 },
    ],
  },
  impact: [
    { label: "Total Revenue", value: "$199.4K", growth: "+284%" },
