...
export const hairProductsEcommerce: CaseStudyData = {
  ...
  headline: "How a DTC Hair Care Brand Achieved a 4.1x Blended ROAS While Building an Organic Traffic Engine — Generating $149.7K in Revenue in 7 Months",
  subheadline: "MEGA deployed always-on AI optimization and creative testing to help a small but ambitious national DTC hair care brand scale from a 1.80x starting ROAS to a 4.25x Black Friday peak — generating over $149.7K in ecommerce revenue across 7 months while simultaneously growing organic traffic from 372 to 5,247 monthly visitors through strategic SEO content.",
  heroStats: [
    { value: "4.08", unit: "x", label: "Peak ROAS Achieved" },
    { value: "$149.7K", unit: "K", label: "Revenue Generated" },
  ...
  paidAds: {
    ...
    monthly: [
      ...
      { month: "Jun '25", spend: 5058, leads: 2748, cpl: 1.12, qualified: 57, cpql: 89, deals: 119, revenue: 10672, roas: 2.11 },
      // Jul 2025: New architecture in place. Creative testing at 12+ variations. AI optimization compounding. Summer hair care demand.
      { month: "Jul '25", spend: 5064, leads: 3118, cpl: 1.04, qualified: 82, cpql: 62, deals: 148, revenue: 14027, roas: 2.77 },
      // Aug 2025: Back-to-school season drives styling product demand. AI agents identified weekend conversion peaks.
      { month: "Aug '25", spend: 5044, leads: 3491, cpl: 0.97, qualified: 87, cpql: 58, deals: 187, revenue: 16343, roas: 3.24 },
      // Sep 2025: Fall transition. AI-optimized creative featuring seasonal hair care routines. Retargeting sequences matured.
      { month: "Sep '25", spend: 5126, leads: 3870, cpl: 0.91, qualified: 90, cpql: 57, deals: 229, revenue: 19325, roas: 3.77 },
      // Oct 2025: Q4 ramp-up. Pre-Black Friday audience warming. Gift bundle campaigns launched.
      { month: "Oct '25", spend: 5329, leads: 4312, cpl: 0.87, qualified: 90, cpql: 59, deals: 277, revenue: 27658, roas: 5.19 },
      // Nov 2025: BLACK FRIDAY / CYBER MONDAY — aggressive spend scale-up. AI managed real-time bid adjustments. Peak ROAS month.
      { month: "Nov '25", spend: 5843, leads: 6764, cpl: 0.86, qualified: 139, cpql: 42.20, deals: 498, revenue: 28981, roas: 4.96 },
      // Dec 2025: Holiday gifting tail. Gift sets and stocking stuffers. Organic traffic reducing paid dependency.
      { month: "Dec '25", spend: 5242, leads: 5782, cpl: 0.83, qualified: 151, cpql: 35.32, deals: 378, revenue: 32658, roas: 6.23 },
    ],
  },
  impact: [
    { label: "Total Revenue", value: "$149.7K", growth: "+79% ROAS improvement" },
    { label: "Total Orders", value: "1,836", growth: "across 7 months" },
    { label: "Average Order Value", value: "$48.33", growth: "hair care category" },
    { label: "Blended ROAS", value: "4.08x", growth: "from 1.80x starting" },
  ],
};
