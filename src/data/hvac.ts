...
export const hvac: CaseStudyData = {
  ...
  seo: {
    summary: [
      { label: "Total Keywords", value: "731", growth: "+471%", from: "from 128" },
      { label: "Top 10 Rankings", value: "81", growth: "+710%", from: "from 10" },
      { label: "Pages Created", value: "76", growth: "", from: "incl. 42 service-area landing pages" },
      { label: "Organic Traffic", value: "1,341/mo", growth: "+310%", from: "from 327" },
    ],
    monthly: [
  ...
  paidAds: {
    summary: [
      ...
      { label: "Avg Cost Per Qualified Lead", value: "$116", note: "↓35% from $178" },
      { label: "Closed Jobs", value: "94" },
    ],
    columnLabels: {
      leads: "Total Leads",
      cpl: "Cost/Lead",
  ...
  organicConversions: {
    summary: [
      { label: "Total Organic Leads", value: "134", growth: "+228%", note: "from ~41 in prior 6 months" },
      { label: "Phone Calls from Organic", value: "94", growth: "+257%" },
      { label: "Form Fills from Organic", value: "40", growth: "+176%" },
      { label: "Organic Conversion Rate", value: "4.3%", growth: "+56%" },
    ],
    columnLabels: {
      calls: "Phone Calls",
    ...
    monthly: [
      ...
      { month: "Sep 2025", formFills: 6, calls: 13, totalLeads: 19, conversionRate: 4.3 },
    ],
    sources: [
      { source: "Google Organic", percentage: 61, leads: 82 },
      { source: "Google Maps / Local Pack", percentage: 25, leads: 33 },
      { source: "Direct (branded search)", percentage: 9, leads: 12 },
      { source: "Bing / Other", percentage: 5, leads: 7 },
    ],
  },
  localSeo: {
    summary: [
      { label: "GBP Profile Views", value: "5,120/mo", growth: "+327%", from: "from 1,198" },
      { label: "Maps Impressions", value: "9,870/mo", growth: "+291%", from: "from 2,524" },
      { label: "GBP Phone Calls", value: "196/mo", growth: "+358%", from: "from 43" },
      { label: "Direction Requests", value: "101/mo", growth: "+276%", from: "from 27" },
    ],
    monthly: [
  ...
  impact: [
    { label: "Total Revenue", value: "$203.2K", growth: "+156%" },
    { label: "Total Qualified Leads", value: "247", growth: "+35% lower CPL" },
    { label: "Avg Revenue Per Job", value: "$2,161", growth: "" },
    { label: "Blended ROAS", value: "6.27x", growth: "" },
  ],
};
