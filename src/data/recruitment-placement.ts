...
export const recruitmentPlacement: CaseStudyData = {
  ...
  headline: "How a National Recruitment Firm Achieved a 25% Lead-to-Placement Conversion Rate in 7 Months with AI-Powered Marketing",
  subheadline: "MEGA helped a mid-size recruitment placement agency increase qualified lead conversion to 25% while reducing lead volume and cutting cost per qualified lead 31% — driving 25 successful placements and $189K in placement revenue with 2,834+ ranking keywords.",
  heroStats: [
    { value: "$189K", unit: "K", label: "Total Placement Revenue" },
    { value: "100", unit: "", label: "Qualified Employer Leads" },
  ...
  strategy: [
    ...
    },
    {
      ...
      items: [
        ...
        "Paid campaign optimization driven by qualification data — shifted from optimizing for lead volume to optimizing for qualified lead cost, reducing CPQL from $648 to $401 by month 5 while increasing qualified lead count from 8 to 18 per month",
    ...
    },
    {
      ...
      items: [
        ...
        "Conversion rate optimization pushed qualified-to-placement rate to 25%, up from 17% at baseline — achieved through tighter lead qualification criteria and AI-driven lead scoring that prioritized high-intent employers with active hiring budgets",
      ],
    },
  ],
  seo: {
  ...
  paidAds: {
    summary: [
      ...
      { label: "Total Leads Generated", value: "300", note: "Employer inquiries and form submissions" },
      { label: "Qualified Leads", value: "100", note: "Employers with budget, timeline, and active hiring need" },
      { label: "Avg Cost per Qualified Lead", value: "$444", note: "↓31% from $648 baseline" },
    ],
    columnLabels: {
    ...
    monthly: [
      { month: "Oct '25", spend: 5187, leads: 28, cpl: 185.25, qualified: 8, cpql: 648.38, deals: 2, revenue: 16200, roas: 3.12 },
      { month: "Nov '25", spend: 5423, leads: 33, cpl: 164.33, qualified: 11, cpql: 493.00, deals: 3, revenue: 24600, roas: 4.54 },
      { month: "Dec '25", spend: 5289, leads: 31, cpl: 170.61, qualified: 10, cpql: 528.90, deals: 2, revenue: 17800, roas: 3.37 },
      { month: "Jan '26", spend: 6841, leads: 44, cpl: 155.48, qualified: 15, cpql: 456.07, deals: 4, revenue: 31200, roas: 4.56 },
      { month: "Feb '26", spend: 7218, leads: 50, cpl: 144.36, qualified: 18, cpql: 401.00, deals: 5, revenue: 33800, roas: 4.68 },
      { month: "Mar '26", spend: 7534, leads: 56, cpl: 134.54, qualified: 20, cpql: 376.70, deals: 5, revenue: 35400, roas: 4.70 },
      { month: "Apr '26", spend: 6892, leads: 58, cpl: 118.83, qualified: 18, cpql: 382.89, deals: 4, revenue: 30000, roas: 4.35 },
    ],
  },
  impact: [
    { label: "Total Placement Revenue", value: "$189,000", growth: "+362%" },
    { label: "Qualified Employer Leads", value: "100 total", growth: "8→20/mo (+150%)" },
    { label: "Blended ROAS", value: "4.26x", growth: "" },
    { label: "Successful Placements", value: "25", growth: "+317%" },
    { label: "Cost per Qualified Lead", value: "$444", growth: "↓31% from $648" },
