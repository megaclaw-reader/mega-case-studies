...
export const retirementPlanningNational: CaseStudyData = {
  ...
  headline: "How a National Retirement Planning Firm Generated 239 Qualified Leads and Cut Cost Per Lead 52% in 12 Months",
  subheadline: "MEGA helped a fee-only retirement planning advisory build a compliant digital acquisition engine — reducing cost per qualified lead by 52%, improving qualification rates from 24% to 44%, and growing organic visibility 4,280%.",
  heroStats: [
    { value: "239", unit: "", label: "Qualified Leads" },
    { value: "83", unit: "", label: "New Clients Acquired" },
  ...
  paidAds: {
    summary: [
      ...
      { label: "Total Leads", value: "620" },
      { label: "Qualified Leads", value: "239" },
      { label: "Avg Cost/Qualified Lead", value: "$391", note: "↓52% from $732" },
      { label: "New Clients", value: "83" },
    ],
    columnLabels: {
      leads: "Total Leads",
      cpl: "Cost/Lead",
    ...
    monthly: [
      { month: "Jan '25", spend: 5127, leads: 29, cpl: 177, qualified: 7, cpql: 732, deals: 2 },
      { month: "Feb '25", spend: 5284, leads: 33, cpl: 160, qualified: 9, cpql: 587, deals: 3 },
      { month: "Mar '25", spend: 5693, leads: 38, cpl: 150, qualified: 12, cpql: 474, deals: 4 },
      { month: "Apr '25", spend: 6341, leads: 44, cpl: 144, qualified: 15, cpql: 423, deals: 5 },
      { month: "May '25", spend: 6782, leads: 48, cpl: 141, qualified: 17, cpql: 399, deals: 6 },
      { month: "Jun '25", spend: 7914, leads: 54, cpl: 147, qualified: 21, cpql: 377, deals: 7 },
      { month: "Jul '25", spend: 7263, leads: 49, cpl: 148, qualified: 18, cpql: 404, deals: 6 },
      { month: "Aug '25", spend: 8417, leads: 56, cpl: 150, qualified: 23, cpql: 366, deals: 8 },
      { month: "Sep '25", spend: 9182, leads: 62, cpl: 148, qualified: 26, cpql: 353, deals: 9 },
      { month: "Oct '25", spend: 10347, leads: 69, cpl: 150, qualified: 30, cpql: 345, deals: 11 },
      { month: "Nov '25", spend: 11218, leads: 74, cpl: 152, qualified: 33, cpql: 340, deals: 12 },
      { month: "Dec '25", spend: 9847, leads: 64, cpl: 154, qualified: 28, cpql: 352, deals: 10 },
    ],
  },
  organicConversions: {
    summary: [
  ...
  impact: [
    { label: "Qualified Leads", value: "239", growth: "7/mo → 33/mo" },
    { label: "New Clients Acquired", value: "83", growth: "2/mo → 12/mo" },
    { label: "Cost Per Qualified Lead", value: "$391", growth: "↓52% from $732" },
    { label: "Qualification Rate", value: "24% → 44%", growth: "+83%" },
