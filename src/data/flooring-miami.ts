...
export const flooringMiami: CaseStudyData = {
  ...
  heroStats: [
    ...
    { value: "$213.9K", unit: "K", label: "Revenue Generated" },
    { value: "3.4", unit: "x", label: "Average ROAS" },
  ],
  ...
  paidAds: {
    summary: [
      ...
      { label: "Qualified Leads", value: "414" },
      { label: "Avg Cost Per Qualified Lead", value: "$151", note: "↓9% from $69" },
      { label: "Closed Deals", value: "152" },
    ],
    monthly: [
      { month: "Jun 2025", spend: 5000, leads: 51, cpl: 98.04, qualified: 29, cpql: 172.41, deals: 11, revenue: 14200, roas: 2.84 },
      { month: "Jul 2025", spend: 5200, leads: 55, cpl: 94.55, qualified: 30, cpql: 173.33, deals: 12, revenue: 16848, roas: 3.24 },
      { month: "Aug 2025", spend: 5400, leads: 58, cpl: 93.1, qualified: 33, cpql: 163.64, deals: 13, revenue: 17064, roas: 3.16 },
      { month: "Sep 2025", spend: 5600, leads: 61, cpl: 91.8, qualified: 36, cpql: 155.56, deals: 14, revenue: 22344, roas: 3.99 },
      { month: "Oct 2025", spend: 5900, leads: 64, cpl: 92.19, qualified: 40, cpql: 147.5, deals: 15, revenue: 22951, roas: 3.89 },
      { month: "Nov 2025", spend: 6100, leads: 65, cpl: 93.85, qualified: 43, cpql: 141.86, deals: 16, revenue: 25864, roas: 4.24 },
      { month: "Dec 2025", spend: 5700, leads: 62, cpl: 91.94, qualified: 42, cpql: 135.71, deals: 13, revenue: 16758, roas: 2.94 },
      { month: "Jan 2026", spend: 5300, leads: 59, cpl: 89.83, qualified: 38, cpql: 139.47, deals: 12, revenue: 18444, roas: 3.48 },
      { month: "Feb 2026", spend: 5800, leads: 62, cpl: 93.55, qualified: 40, cpql: 145.0, deals: 14, revenue: 16530, roas: 2.85 },
      { month: "Mar 2026", spend: 6200, leads: 67, cpl: 92.54, qualified: 40, cpql: 155.0, deals: 15, revenue: 19530, roas: 3.15 },
      { month: "Apr 2026", spend: 6450, leads: 70, cpl: 92.14, qualified: 43, cpql: 150.0, deals: 17, revenue: 23349, roas: 3.62 },
    ],
  },
  impact: [
