...
export const flooringMiami: CaseStudyData = {
  ...
  paidAds: {
    summary: [
      ...
      { label: "Qualified Leads", value: "827" },
      { label: "Avg Cost Per Qualified Lead", value: "$77", note: "↓43% from $69" },
      { label: "Closed Deals", value: "127" },
    ],
    monthly: [
      { month: "Jun 2025", spend: 5000, leads: 119, cpl: 42, qualified: 72, cpql: 69, deals: 11, revenue: 68250, roas: 3.7 },
      { month: "Jul 2025", spend: 5200, leads: 127, cpl: 41, qualified: 78, cpql: 67, deals: 12, revenue: 76800, roas: 3.9 },
      { month: "Aug 2025", spend: 5400, leads: 134, cpl: 40, qualified: 83, cpql: 65, deals: 13, revenue: 89700, roas: 4.1 },
      { month: "Sep 2025", spend: 5600, leads: 142, cpl: 39, qualified: 89, cpql: 63, deals: 14, revenue: 98000, roas: 4.3 },
      { month: "Oct 2025", spend: 5900, leads: 148, cpl: 40, qualified: 95, cpql: 62, deals: 15, revenue: 105750, roas: 4.4 },
      { month: "Nov 2025", spend: 6100, leads: 152, cpl: 40, qualified: 98, cpql: 62, deals: 16, revenue: 113600, roas: 4.6 },
      { month: "Dec 2025", spend: 5700, leads: 143, cpl: 40, qualified: 91, cpql: 63, deals: 13, revenue: 87750, roas: 4.0 },
      { month: "Jan 2026", spend: 5300, leads: 138, cpl: 38, qualified: 87, cpql: 61, deals: 12, revenue: 79200, roas: 3.9 },
      { month: "Feb 2026", spend: 5800, leads: 145, cpl: 40, qualified: 93, cpql: 62, deals: 14, revenue: 96600, roas: 4.2 },
      { month: "Mar 2026", spend: 6200, leads: 156, cpl: 40, qualified: 101, cpql: 61, deals: 15, revenue: 108750, roas: 4.3 },
      { month: "Apr 2026", spend: 6450, leads: 163, cpl: 40, qualified: 107, cpql: 60, deals: 17, revenue: 122700, roas: 4.7 },
    ],
  },
  impact: [
    { label: "CPQL Reduction", value: "43%", growth: "from $69 to $60" },
    { label: "Total Revenue", value: "$847K", growth: "127 deals closed" },
    { label: "Average ROAS", value: "4.2x", growth: "peak 4.7x" },
